											...
											<div>
												<div class="space-top-8">
													...
													<div class="">
														<div>
															<p>
																<strong><span>เธอว่างจองที่พักเริ่มตั้งแต่14 ตุลา</span></strong>
															</p>
															<p>
																<span>ลูกำลังวางแผนการเดินทางและคิดว่าที่พักของคุณเหมาะกับการเดินทางของเธอ</span>
															</p>
														</div>
													</div>
												</div>
												<div class="space-top-8">
													...
													<div class="">
														<div>
															<p>
																<strong><span>ผู้เข้าพักส่งข้อความพร้อมคำขอจองของพวกเขา</span></strong>
															</p>
															<p>
																<span>ลูบอกว่าเธอจะมาที่เมืองสำหรับงานและเธอต้องการพักกับคุณ</span>
															</p>
														</div>
													</div>
												</div>
												<div class="space-top-8">
													...
													<div class="">
														<div>
															...
															<p>
																<span>ลูกำลังรอการตอบกลับจากคุณเพื่อวางแผนการเดินทางส่วนที่เหลือ</span>
															</p>
														</div>
													</div>
												</div>
												<div class="space-top-8">
													<div class="space-2 booking-scenario__welcome-guest"></div>
													<div class="">
														<div>
															<p>
																<strong>ต้อนรับผู้เข้าพักเข้าที่พักของคุณ!</span></strong>
															</p>
															<p>
																<span>ก่อนลูมาถึง ให้คุยรายละเอียดเช่นเวลาเช็คอินและการแลกเปลี่ยนกุญแจ</span>
															</p>
														</div>
													</div>
												</div>
													...
													<div class="no-margin-padding__sm main-panel-padding main-panel-progress pull-right main-panel-inner-half space-sm-8">
														...
														<div class="row no-margin-padding__sm">
															<div class="main-panel__actions col-sm-12 no-margin-padding__sm">
																<div>
																	<a class="btn-progress-back link-icon va-container va-container-v pull-left text-gray link--accessibility-outline" href="/become-a-host/"> <span class="icon hide-sm"></span><span class="va-middle"><h5 class="text-normal"><span>กลับไป</span></h5> </span> </a>
																	<a class="btn btn-large btn-progress-next btn-large__next-btn pull-right-md btn-soft-dark" href="/become-a-host/bedrooms">
