...
<html lang="en">
	...
	<body class="with-new-header ">
		...
		<main id="site-content" role="main">
			...
			<script src="https://a0.muscache.com/airbnb/static/vendor/flexibility-27006ad9f79eed4c38dff451e54b9b9a.js" type="text/javascript"></script>
			...
			<div id="lys-redesign-div">
				<div>
					<div>
						<div class="bg-white">
							<div>
								<div class="airbnb-header new list-your-space__header list-your-space__header-sm bg-medium show-sm">
									<a href="/" class="link-reset belo-container pull-left text-logo" aria-label="Rentcnd"> Rentcnd </a>
								</div>
										...
										<div class="landing__left-col-content">
											...
											<span>
												<div class="landing__publish-section">
													...
													<p class="text-gray">
														<span>ไม่นานหลังจากนี้ รถเช่าของคุณจะปรากฏบน Rentcnd ผู้ใช้คนอื่นสามารถจองตามที่ปฏิทินของคุณแสดงว่าบริการรถเช่าพร้อมคนขับของคุณว่าง</span>
													</p>
													<p class="text-rausch">
