...
<html lang="en">
	<head>
		...
		<title>แก้ไข รายละเอียด สำหรับรถเช่า Rentcnd ของคุณ</title>
													...
													<div class="no-margin-padding__sm main-panel-padding main-panel-progress pull-right main-panel-inner-half space-sm-8">
														...
														<div class="row no-margin-padding__sm">
															<div class="main-panel__actions col-sm-12 no-margin-padding__sm">
																<div>
																	<a class="btn-progress-back link-icon va-container va-container-v pull-left text-gray link--accessibility-outline" href="photos.php?id=<?php if(isset($_GET['id'])){ echo $_GET['id'];}?>"> <span class="icon hide-sm"></span><span class="va-middle"><h5 class="text-normal"><span>กลับไป</span></h5> </span> </a>
																	<a id="next-description" class="btn btn-large btn-progress-next btn-large__next-btn pull-right-md btn-soft-dark" href="title.php<?php if(isset($_GET['id'])){ echo '?id='.$_GET['id'];}?>">
