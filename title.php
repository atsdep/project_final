										...
										<div class="main-panel main-panel-padding main-panel-progress pull-right main-panel-inner-half space-sm-8">
											...
											<div data-reactid="1">
												<fieldset class="lys-input__fieldset">
													<input type="text" aria-label="ชื่อประกาศ" placeholder="ชื่อประกาศ" value="" minlength="0" maxlength="50"class="lys-title__input">
										...
										<div class="hide-sm help-panel panel">
											<div class="panel-body">
												...
												<div class="help-panel__text">
													<div>
														<p>
															<span data-reactid=".28fvf268sg.1.4.0.1.0.0.1.0.1.0">มีบางตัวอย่างจากที่พักใกล้เคียง</span>
														</p>
														<div class="va-container va-container-v space-1">
															<div class="pull-left lys-similar-listing__cover-img preview-card__img-container" style="height:75px;width:100px;background-position:center;background-size:cover;">
																<div title="ภาพหน้าแรกของที่พัก" style="height:75px;width:100px;background-position:center;background-size:cover;background-image:url(img/car.jpg?aki_policy=small);"></div>
															</div>
															<div class="va-middle">
